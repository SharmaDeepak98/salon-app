        ...
        <div className="relative h-full grid grid-cols-2">
          <div className="flex flex-col justify-center pl-8 md:pl-16 lg:pl-24 absolute">
            ...
            >
              ...
              experienced stylists is here to provide you with personalized
              care, premium products, and innovative techniques that leave you
              feeling radiant inside and out. Whether you're craving a bold new
              style, a subtle refresh, or a soothing treatment, we're dedicated
              to making every visit a luxurious experience that inspires your
              best self.
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
