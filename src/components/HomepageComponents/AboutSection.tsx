          ...
          >
            <div className="md:col-span-5 text-white">
              ...
              <motion.p
                ...
                variants={textVariants}
              >
                Here at Honey Hair we intentionally design custom colors for
                every client who walks through our doors. We believe in
                beautiful, soft coloring and blending techniques that guarantee
                our clients easy and seamless grow outs in between appointments.
              </motion.p>
              <motion.button
